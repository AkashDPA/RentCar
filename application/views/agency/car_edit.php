    ...
    <div class="col-lg-6 col-md-8 mx-auto">
        <div class="card rounded shadow shadow-sm">
            ...
            <div class="card-body mx-3">
                <?php echo form_open_multipart('agency/car_actions/edit/'.$car_details['id']); ?>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-8">
                        <div class="input-group">
                            ...
                            <input id="vehicle_model" name="vehicle_model" type="text" class="form-control" required="required" value="<?=$car_details['model']?>">
                        </div>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-8">
                        <div class="input-group">
                            ...
                            <input id="vehicle_number" name="vehicle_number" type="text" class="form-control" value="<?=$car_details['number']?>">
                        </div>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-8">
                        <div class="input-group">
                            ...
                            <input id="seating_capacity" name="seating_capacity" type="number" class="form-control" value="<?=$car_details['seating_capacity']?>">
                        </div>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-8">
                        <div class="input-group">
                            ...
                            <input id="rent_per_day" name="rent_per_day" type="number" class="form-control" value="<?=$car_details['rent_per_day']?>">
                        </div>
                    </div>
                </div>
                <div class="form-group row">
